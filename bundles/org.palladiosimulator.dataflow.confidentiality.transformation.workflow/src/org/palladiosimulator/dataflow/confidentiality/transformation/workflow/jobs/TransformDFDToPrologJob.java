...
public class TransformDFDToPrologJob extends QVTOTransformationJob {
	...
	public TransformDFDToPrologJob(ModelLocation dfdLocation, ModelLocation prologLocation, NameDerivationMethod nameDerivationMethod) {
		super(createQVTOConfiguration(dfdLocation, prologLocation, nameDerivationMethod));
	}
	
	public TransformDFDToPrologJob(ModelLocation dfdLocation, ModelLocation prologLocation) {
		this(dfdLocation, prologLocation, NameDerivationMethod.NAME_AND_ID);
	}

	private static QVTOTransformationJobConfiguration createQVTOConfiguration(ModelLocation dfdLocation, ModelLocation prologLocation, NameDerivationMethod nameDerivationMethod) {
