...
/**
 * This is the item provider adapter for a {@link org.palladiosimulator.dataflow.dictionary.characterized.DataDictionaryCharacterized.expressions.UnaryLogicTerm} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UnaryLogicTermItemProvider extends LogicTermItemProvider
{
	/**
	 ...
	 * @generated
	 */
	public UnaryLogicTermItemProvider(AdapterFactory adapterFactory)
	{
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
	{
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExpressionsPackage.Literals.UNARY_LOGIC_TERM__TERM);
		}
	...
	{
		String label = ((UnaryLogicTerm)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_UnaryLogicTerm_type") :
			getString("_UI_UnaryLogicTerm_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(UnaryLogicTerm.class)) {
			case ExpressionsPackage.UNARY_LOGIC_TERM__TERM:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
	{
		...
		newChildDescriptors.add
			(createChildParameter
				(ExpressionsPackage.Literals.UNARY_LOGIC_TERM__TERM,
