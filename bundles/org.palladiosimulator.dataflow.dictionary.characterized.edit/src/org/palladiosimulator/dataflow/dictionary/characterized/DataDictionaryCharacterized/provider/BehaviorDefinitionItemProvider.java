...
public class BehaviorDefinitionItemProvider extends BehaviorDefinitionItemProviderGen {
    ...
    public Object getCreateChildImage(Object owner, Object feature, Object child, Collection<?> selection) {
        if (Arrays.asList(DataDictionaryCharacterizedPackage.Literals.BEHAVIOR_DEFINITION__INPUTS, feature == DataDictionaryCharacterizedPackage.Literals.BEHAVIOR_DEFINITION__OUTPUTS).contains(feature)) {
            var reference = (EReference)feature;
            String name = "full/ctool16/Create" + reference.getEContainingClass().getName() + "_" + reference.getName() + ".png";
