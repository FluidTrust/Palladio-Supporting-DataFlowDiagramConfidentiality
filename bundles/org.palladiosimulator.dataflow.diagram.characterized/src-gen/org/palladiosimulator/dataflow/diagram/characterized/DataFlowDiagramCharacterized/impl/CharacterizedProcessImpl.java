...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Characterized Process</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.dataflow.diagram.characterized.DataFlowDiagramCharacterized.impl.CharacterizedProcessImpl#getBehavior <em>Behavior</em>}</li>
 *   <li>{@link org.palladiosimulator.dataflow.diagram.characterized.DataFlowDiagramCharacterized.impl.CharacterizedProcessImpl#getOwnedBehavior <em>Owned Behavior</em>}</li>
 *   <li>{@link org.palladiosimulator.dataflow.diagram.characterized.DataFlowDiagramCharacterized.impl.CharacterizedProcessImpl#getReferencedBehavior <em>Referenced Behavior</em>}</li>
 *   <li>{@link org.palladiosimulator.dataflow.diagram.characterized.DataFlowDiagramCharacterized.impl.CharacterizedProcessImpl#getCharacteristics <em>Characteristics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CharacterizedProcessImpl extends ProcessImpl implements CharacterizedProcess {
	 ...
	 * @generated
	 */
	protected CharacterizedProcessImpl() {
		super();
	}
	...
	public NotificationChain basicSetOwnedBehavior(BehaviorDefinition newOwnedBehavior, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__OWNED_BEHAVIOR, oldOwnedBehavior, newOwnedBehavior);
	...
	public void setOwnedBehavior(BehaviorDefinition newOwnedBehavior) {
		if (newOwnedBehavior != ownedBehavior) {
			...
			if (ownedBehavior != null)
				msgs = ((InternalEObject)ownedBehavior).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__OWNED_BEHAVIOR, null, msgs);
			if (newOwnedBehavior != null)
				msgs = ((InternalEObject)newOwnedBehavior).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__OWNED_BEHAVIOR, null, msgs);
			msgs = basicSetOwnedBehavior(newOwnedBehavior, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__OWNED_BEHAVIOR, newOwnedBehavior, newOwnedBehavior));
	}
	...
	public BehaviorDefinition getReferencedBehavior() {
		if (referencedBehavior != null && referencedBehavior.eIsProxy()) {
			...
			if (referencedBehavior != oldReferencedBehavior) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__REFERENCED_BEHAVIOR, oldReferencedBehavior, referencedBehavior));
			}
		}
	...
	public void setReferencedBehavior(BehaviorDefinition newReferencedBehavior) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__REFERENCED_BEHAVIOR, oldReferencedBehavior, referencedBehavior));
	}
	...
	public EList<Characteristic> getCharacteristics() {
		if (characteristics == null) {
			characteristics = new EObjectContainmentEList<Characteristic>(Characteristic.class, this, DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__CHARACTERISTICS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__OWNED_BEHAVIOR:
				return basicSetOwnedBehavior(null, msgs);
			case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__CHARACTERISTICS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__BEHAVIOR:
				if (resolve) return getBehavior();
				return basicGetBehavior();
			case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__OWNED_BEHAVIOR:
				return getOwnedBehavior();
			case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__REFERENCED_BEHAVIOR:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Behaving.class) {
			switch (derivedFeatureID) {
				case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__BEHAVIOR: return DataDictionaryCharacterizedPackage.BEHAVING__BEHAVIOR;
				case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__OWNED_BEHAVIOR: return DataDictionaryCharacterizedPackage.BEHAVING__OWNED_BEHAVIOR;
				case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__REFERENCED_BEHAVIOR: return DataDictionaryCharacterizedPackage.BEHAVING__REFERENCED_BEHAVIOR;
				default: return -1;
			}
		}
		if (baseClass == Characterizable.class) {
			switch (derivedFeatureID) {
				case DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__CHARACTERISTICS: return DataFlowDiagramCharacterizedPackage.CHARACTERIZABLE__CHARACTERISTICS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Behaving.class) {
			switch (baseFeatureID) {
				case DataDictionaryCharacterizedPackage.BEHAVING__BEHAVIOR: return DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__BEHAVIOR;
				case DataDictionaryCharacterizedPackage.BEHAVING__OWNED_BEHAVIOR: return DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__OWNED_BEHAVIOR;
				case DataDictionaryCharacterizedPackage.BEHAVING__REFERENCED_BEHAVIOR: return DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__REFERENCED_BEHAVIOR;
				default: return -1;
			}
		}
		if (baseClass == Characterizable.class) {
			switch (baseFeatureID) {
				case DataFlowDiagramCharacterizedPackage.CHARACTERIZABLE__CHARACTERISTICS: return DataFlowDiagramCharacterizedPackage.CHARACTERIZED_PROCESS__CHARACTERISTICS;
				default: return -1;
			}
		}
		if (baseClass == CharacterizedNode.class) {
