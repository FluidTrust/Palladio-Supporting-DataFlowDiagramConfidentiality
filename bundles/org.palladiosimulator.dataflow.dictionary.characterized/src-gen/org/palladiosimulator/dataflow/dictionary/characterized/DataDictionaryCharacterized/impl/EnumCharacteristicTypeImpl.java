 ...
 * </p>
 * <ul>
 *   <li>{@link org.palladiosimulator.dataflow.dictionary.characterized.DataDictionaryCharacterized.impl.EnumCharacteristicTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumCharacteristicTypeImpl extends CharacteristicTypeImpl implements EnumCharacteristicType
{
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataDictionaryCharacterizedPackage.ENUM_CHARACTERISTIC_TYPE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Enumeration newType)
	{
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataDictionaryCharacterizedPackage.ENUM_CHARACTERISTIC_TYPE__TYPE, oldType, type));
	}
	...
	{
		switch (featureID) {
			case DataDictionaryCharacterizedPackage.ENUM_CHARACTERISTIC_TYPE__TYPE:
